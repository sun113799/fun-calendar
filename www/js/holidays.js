...
var LEGAL_REST_DAYS = {
  ...
  '2025-09-28': '班','2025-10-11': '班', // 调休

  // === 2026 ===
  // 元旦：1月1日-3日
  '2026-01-01': '休','2026-01-02': '休','2026-01-03': '休',
  // 春节：2月17日-23日（农历正月初一~初七）
  '2026-02-17': '休','2026-02-18': '休','2026-02-19': '休','2026-02-20': '休',
  '2026-02-21': '休','2026-02-22': '休','2026-02-23': '休',
  '2026-02-15': '班','2026-02-28': '班', // 调休
  // 清明节：4月5日-7日
  '2026-04-05': '休','2026-04-06': '休','2026-04-07': '休',
  // 劳动节：5月1日-5日
...
function getRestDay(year, month, day) {
  ...
  return LEGAL_REST_DAYS[key] || null;
}
